# TODO -> cite: https://web.archive.org/web/20190908233339/http://blog.sadafnoor.me/blog/how-to-add-flask-admin-to-a-blueprint/
...
class AdminBlueprint(Blueprint):
    ...
    def register(self,app, options, first_registration=False):
        admin = Admin(app, name='CoCo Office Suite')
